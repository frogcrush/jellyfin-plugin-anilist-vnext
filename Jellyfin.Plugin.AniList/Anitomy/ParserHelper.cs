...
namespace AnitomySharp
{
  ...
  {
        private static readonly System.Buffers.SearchValues<char> s_multiplicationChars = System.Buffers.SearchValues.Create("xX\u00D7");
    ...
    {
      return Dashes.Contains(c.ToString(), StringComparison.Ordinal);
    }
    ...
    public static bool IsResolution(string str)
    {
      ...
      {
        var pos = str.AsSpan().IndexOfAny(s_multiplicationChars);
