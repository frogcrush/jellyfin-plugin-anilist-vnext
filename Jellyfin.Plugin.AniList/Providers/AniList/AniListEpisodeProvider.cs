...
using Jellyfin.Plugin.AniList.Anitomy;
...
namespace Jellyfin.Plugin.AniList.Providers.AniList
{
    public class AniListEpisodeProvider : IRemoteMetadataProvider<Episode, EpisodeInfo>
    {
        ...
        public Task<MetadataResult<Episode>> GetMetadata(EpisodeInfo info, CancellationToken cancellationToken)
        {
            ...
            {
                // Set episode number
                IndexNumber = AnitomyHelper.ExtractEpisodeNumber(info.Path),
                // Set season number
                ParentIndexNumber = AnitomyHelper.ExtractSeasonNumber(info.Path)
            };
